...
private:
	...
	static const GLchar *TEXTURE_VERTEX_SHADER, *TEXTURE_FRAGMENT_SHADER;

    // Ressources OpenGL
    GLuint m_ProgramID, m_PolygonProgramID, m_LineProgramID, m_TextureProgramID;
	...
	GLuint	m_TextureVAOID, m_TextureVBOID[2];

    // Uniform locations
    GLint m_uParticleColor;
    GLint m_uParticlePosition;
    GLint m_uParticleScale;
	GLint m_uDiffuseLocation, m_uParticlePositionLocation, m_uParticleScaleLocation, m_uParticleSexLocation;
